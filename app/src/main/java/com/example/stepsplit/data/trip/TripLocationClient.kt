...
interface TripLocationClient {
     ...
     * [com.example.stepsplit.trip.service.TripRecordingService]. Default no-op so [FakeTripLocationClient]
     * doesn't need to implement it; callers must still bound how long they wait for the effect of
     * this call to arrive through [locationUpdates], since delivery itself is asynchronous.
     */
    suspend fun flush() {}
}
